...
<?php // for Delete dala
    ...
    if(isset($_GET['del_id'])){
        ...
        $del_data = mysql_query("DELETE FROM teachers WHERE email = '$id' ");
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Teachers List <a href="index.php?id=teacher_new" class="btn btn-info"> Add New + </a></h3>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            <?php
                                                $sl = 1;
                                                $data = mysql_query("SELECT A.id, A.name, A.email, B.id AS user_id, B.mobile, B.address, 
                                                    C.name as department
                                                    FROM teachers AS A INNER JOIN tbl_user_info AS B 
                                                    INNER JOIN departments AS C 
                                                    ON A.email = B.user_name AND A.department_id = C.id 
                                                    WHERE B.role = 2");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="index.php?id=course_assign&t_id=<?php echo $d->id; ?>"> Assign Course </a> | 
                                                        <a href="index.php?id=teacher_edit&edit_id=<?php echo $d->id; ?>"> Edit </a> | 
                                                        <a href="index.php?id=teacher_list&del_id=<?php echo $d->email; ?>"> Delete </a>
