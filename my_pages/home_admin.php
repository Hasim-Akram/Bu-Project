                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-carousel">
                                ...
                                <div class="widget-controls">                                
                                    <a href="wsdindex.html#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                                </div>                             
                            </div>         
                            <!-- END WIDGET SLIDER -->
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-danger widget-padding-sm">
                                ...
                                <div class="widget-controls">                                
                                    <a href="wsdindex.html#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="left" title="Remove Widget"><span class="fa fa-times"></span></a>
                                </div>                            
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls panel-controls-title">                                        
                                        ...
                                        <li><a href="wsdindex.html#" class="panel-fullscreen rounded"><span class="fa fa-expand"></span></a></li>
                                    </ul>                                    
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls" style="margin-top: 2px;">
                                        <li><a href="wsdindex.html#" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
                                        <li><a href="wsdindex.html#" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
                                        <li class="dropdown">
                                            <a href="wsdindex.html#" class="dropdown-toggle" data-toggle="dropdown"><span class="fa fa-cog"></span></a>                                        
                                            <ul class="dropdown-menu">
                                                <li><a href="wsdindex.html#" class="panel-collapse"><span class="fa fa-angle-down"></span> Collapse</a></li>
                                                <li><a href="wsdindex.html#" class="panel-remove"><span class="fa fa-times"></span> Remove</a></li>
                                            </ul>                                        
                                        </li>                                        
                                    </ul>
                                </div>
